...
public class CategoryRepositoryImpl implements CategoryRepository {
    ...
    @Override
    public Category findById1(Integer userId, Integer categoryId) throws EtResourceNotFoundException {
        try {
    ...
    @Override
    public void update1(Integer userId, Integer categoryId, Category category) throws EtBadRequestException {
        try {
